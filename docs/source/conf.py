...
# kedro_code_forensics documentation build
...
from kedro_code_forensics import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_code_forensics"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_code_forensicsdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_code_forensics.tex",
        "kedro_code_forensics Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_code_forensics",
        "Project kedro_code_forensics codebase.",
        "Data-Science",
    )
]
